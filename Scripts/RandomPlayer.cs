namespace Chess_Application {
    public class RandomPlayer : Bot {
        private Random rand;

        public RandomPlayer(Board board, MoveGenerator moveGenerator, Action<Move> onMoveChosen) : base(board, moveGenerator, onMoveChosen) {
            rand = new Random();
        }
