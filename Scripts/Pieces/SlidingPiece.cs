...
#nullable enable
        ...
        public bool CanProceedInDirection(Board board, int targetSquare, bool ignoreOpponentsKing = false) {
            ...
            if (blockingPiece != null) {
                ...
                if (ignoreOpponentsKing && blockingPiece.PieceTeam != PieceTeam && blockingPiece is King)
                    return true;
                return false;
            }
            return true;
        ...
        // public static ulong GenerateDiagonalSlidersAttacks(Board board, ulong diagonalSlidersBitboard, ulong allPiecesBitboard) {
        //     ulong attacks = 0;
        //     while (diagonalSlidersBitboard != 0) {
        //         int squareIndex = BitboardHelper.PopLeastSignificantBit(ref diagonalSlidersBitboard);
        //         (board.pieces[squareIndex] as SlidingPiece)?.GetAttacks(board, allPiecesBitboard);
        //     }
        //     return attacks;
        // }
        
        // public static ulong GenerateCardinalSlidersAttacks(Board board, ulong cardinalSlidersBitboard, ulong allPiecesBitboard) {
        //     ulong attacks = 0;
        //     while (cardinalSlidersBitboard != 0) {
        //         int squareIndex = BitboardHelper.PopLeastSignificantBit(ref cardinalSlidersBitboard);
        //         (board.pieces[squareIndex] as SlidingPiece)?.GetAttacks(board, allPiecesBitboard);
        //     }
        //     return attacks;
        // }
