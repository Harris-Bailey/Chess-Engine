namespace Chess_Application {
    public class Queen : SlidingPiece {
        ...
        //     // ulong attackedSquares = this.attackedSquares;
        //     // ulong friendlyPieces = board.GetTeamBitboard(team);
        //     // // this removes any friendly pieces from the attacks
        //     // attackedSquares &= ~friendlyPieces;
        //     // while (attackedSquares != 0) {
        //     //     int targetSquareIndex = BitboardHelper.PopLeastSignificantBit(ref attackedSquares);
        //     //     new Move(squareIndex, targetSquareIndex);
        //     // }
        // }
